...
{
    public partial class GyroscopeForm : DockContent
    {
        public static bool firstdata_b = true;
        public GyroscopeForm()
        {
            InitializeComponent();
        }

        private void GyroscopeForm_Load(object sender, EventArgs e)
        {
        ...
        public void UpdateGraph(SensorDataItem sensorData)
        {
            if (firstdata_b)
            {
                Title title = new Title("GyroscopeForm", Docking.Top);
